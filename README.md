...
**Play against the bot [here](https://www.jacobh.co.uk/backgammon)!** The current version has a 42–43% win rate against GNU Backgammon using a neural network to evaluate board positions with no look-ahead.
